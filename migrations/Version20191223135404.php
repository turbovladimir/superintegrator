 ...
 */
final class Version20191223135404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE archives (id INT AUTO_INCREMENT NOT NULL, source LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, log_data LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, added_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE test_xml (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(80) NOT NULL COLLATE utf8_general_ci, url VARCHAR(80) NOT NULL COLLATE utf8_general_ci, xml TEXT DEFAULT NULL COLLATE utf8_general_ci, added_at DATETIME NOT NULL, UNIQUE INDEX id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
    }
